...
menu.addEventListener("click", () => {
    ...
    setTimeout(function(){slideDown ?
      body.style.overflowY = "hidden" : body.style.overflowY = "scroll";},300);
})
nav.addEventListener("click", () =>{
    ...
    setTimeout(function(){body.style.overflowY = "scroll";},200);
...
var project = [{
  ...
  linkCode: "https://github.com/o-LUCY-o/Portfolio"
},{
  ...
  linkDemo: "https://www.skrytavystava.cz/portfolio/work-in-progress.html",
  linkCode: "https://www.skrytavystava.cz/portfolio/work-in-progress.html",
...
projectButton[i].addEventListener("click", () => {
  ...
  <div class="project-box">
    ...
    <div class="project-info">
        ...
        <ul class="project-coding-lng">
            ${list[i].join("")}
        </ul>
        <div class="project-about-title">O Projektu</div>
        <div class="project-about"><p>${project[i].description}</p></div>
        <div class="project-buttons">
            <a class="project-button demo" href="${project[i].linkDemo}" rel="noopener noreferrer" target="_blank">
            ...
            DEMO</a>
            <a class="project-button code" href="${project[i].linkCode}" rel="noopener noreferrer" target="_blank">
...
const projects = document.querySelectorAll(".project, .excercise");
...
const headerPE = document.querySelectorAll(".projects-title, .projects-text, .excercises-title, .excercises-text");
const oddexcercises = document.querySelectorAll(".excercise:nth-of-type(odd)");
const evenexcercises = document.querySelectorAll(".excercise:nth-of-type(even)");

/*animation */
const anchor = document.querySelectorAll("a[href$='#home'], a[href$='#projects'], a[href$='#excercises']");
anchor.forEach(a => {
  ...
  a.addEventListener("click", () => {
    ...
    setTimeout(()=>{
      oddProjects.forEach(p => aniSide(p,"fromLeft"));
      evenProjects.forEach(p => aniSide(p,"fromRight"));
    },200);
...
anchor.forEach(a => {
  a.addEventListener("click", () =>{
    sections.forEach(s => {
      ...
      s.style.opacity = "0";
      setTimeout(()=>{s.style.transition ="opacity 1s linear";
...
const moveContactDown = document.querySelectorAll("a[href$='#projects'], a[href$='#excercises']");
const moveContactUp = document.querySelectorAll("a[href$='#home']");
moveContactDown.forEach(m => {
  m.addEventListener("click", () => {document.querySelector(".contact-wrapper").style.top = "65%";})
})
moveContactUp.forEach(m => {
  m.addEventListener("click", () => {document.querySelector(".contact-wrapper").style.top = "";})
})
